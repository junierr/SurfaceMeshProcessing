...
public:
	...
	/**/
	static double AverageAera(const Mesh &mesh);
	static double AverageC(const Mesh & mesh);
	static double getcircle(const Mesh & mesh);
	//static void drawnormal(const Mesh & mesh);
};
