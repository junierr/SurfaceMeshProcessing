...
void SurfaceMeshProcessing::CreateActions(void)
{
	...
	actCircle = new QAction(tr("Circle"), this);
	actCircle->setIcon(QIcon(":/SurfaceMeshProcessing/Images/circle.png"));
	actCircle->setStatusTip(tr("Show circle"));
	actCircle->setCheckable(true);
	connect(actCircle, SIGNAL(toggled(bool)), viewer, SLOT(ShowCircle(bool)));

	actNormal = new QAction(tr("Normal"), this);
	actNormal->setIcon(QIcon(":/SurfaceMeshProcessing/Images/normal.png"));
	actNormal->setStatusTip(tr("Show normal"));
	actNormal->setCheckable(true);
	connect(actNormal, SIGNAL(toggled(bool)), viewer, SLOT(ShowNormal(bool)));
...
void SurfaceMeshProcessing::CreateMenus(void)
{
	...
	menuView->addAction(actCircle);
	menuView->addAction(actNormal);
...
void SurfaceMeshProcessing::CreateToolBars(void)
{
	...
	tbView->addAction(actCircle);
	tbView->addAction(actNormal);
